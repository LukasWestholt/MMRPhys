...
if __name__ == "__main__":
    ...
    if config.TOOLBOX_MODE == "train_and_test" or config.TOOLBOX_MODE == "only_train":
        ...
        elif config.TRAIN.DATA.DATASET == "SCAMPSBigSmall":
            train_loader = data_loader.SCAMPSLoaderBigSmall.SCAMPSLoaderBigSmall
        ...
        elif config.VALID.DATA.DATASET == "SCAMPSBigSmall":
            valid_loader = data_loader.SCAMPSLoaderBigSmall.SCAMPSLoaderBigSmall
    ...
    if config.TOOLBOX_MODE == "only_train":
        ...
        elif config.TEST.DATA.DATASET == "SCAMPSBigSmall":
            test_loader = data_loader.SCAMPSLoaderBigSmall.SCAMPSLoaderBigSmall
